...
private:
	...
	ColorTarget m_GBufferAlbedoTarget;
	...
	void DrawGBuffer(ID3D12GraphicsCommandList* pCmdList, const DirectX::SimpleMath::Vector3& lightForward, const DirectX::SimpleMath::Matrix& viewProj);
