...
class SWTessSampleApp : public App
{
public:
	SWTessSampleApp(uint32_t width, uint32_t height);
	virtual ~SWTessSampleApp();
...
private:
	...
	VertexBuffer m_SWTessResultVB;
	IndexBuffer m_SWTessResultIB;
